    ...
    <header className="site-header">
      <div className="container">
        <Grid container justifyContent="space-between" alignItems="center">
          <Grid item>
            <Button component={RouterLink} to="/" className="ml-3">
              Products
            </Button>
            <Button component={RouterLink} to="/wishlist" className="ml-3">
              Wishlist
            </Button>
            ...
            {isLoggedIn ? (
              ...
              <>
                <Button component={RouterLink} to="/account" className="ml-3" onClick={handleClick}>
                  Account
                </Button>
                <Menu
                  id="basic-menu"
